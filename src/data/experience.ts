...
export const experiences: Experience[] = [
  {
    ...
    description: [
      "Developed CI/CD pipelines for the Dell Lightning storage platform, improving build and deployment consistency",
      "Led packaging and integration for the product’s first release, consolidating components from multiple engineering teams into a single, production ready deliverable",
      "Owned the automation and build process for Nvidia DOCA OFED drivers, ensuring reliable installation and compatibility across target Linux environments",
      "Automated performance testing using Bash and Python, significantly reducing manual testing effort and freeing DevOps engineers for higher value work",
    ],
    technologies: ["Python", "Bash", "Groovy", "Jenkins", "CI/CD"],
    images: [],
